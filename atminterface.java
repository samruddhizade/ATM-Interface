...
<html>
  <head>
    ...
    />
    <link rel="canonical" href="https://www.programiz.com/java-programming/online-compiler/" />    <meta
      name="description"
      content="The user friendly Java online compiler that allows you to Write Java code and run it online. The Java text editor also supports taking input from the user and standard libraries. It uses the OpenJDK 11 compiler to compile code."
    />
        ...
        <div class="nav-menu">
          ...
          <div class="nav-menu-list">
            ...
            <a
              ...
              class="change-lang-row java active"
      ...
      <div class="wrapper">
              ...
              <h1 class="logo-title-wrapper">
                <a href="https://www.programiz.com/" target="_blank" class="logo-link" >
                  ...
                  <span class="logo-sub-title-wrapper">
                    <span class="logo-sub-title">Online Java Compiler</span>
                  </span>
                </a>
              </h1>
            </div>
        ...
        <div class="sidebar-wrapper">
          ...
          <a
            target="_blank"
            href="https://www.programiz.com/java-programming/online-compiler/"
            class="change-lang-btn java active"
            title="Online Java Compiler"
          >
            <img
              class="change-lang-btn-icon svg"
        ...
        <div class="editor-wrapper">
          <div class="editor-desktop-top-bar">
            <div class="file-name">Main.java</div>
